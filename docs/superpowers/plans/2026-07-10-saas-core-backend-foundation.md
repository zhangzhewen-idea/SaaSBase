...
spring:
  datasource:
    url: jdbc:mysql://${SAASBASE_DATASOURCE_HOST}:3306/saasbase?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true
...
services:
  migration:
    ...
    environment:
      ...
      SAASBASE_DATASOURCE_HOST: ${SAASBASE_DATASOURCE_HOST}
