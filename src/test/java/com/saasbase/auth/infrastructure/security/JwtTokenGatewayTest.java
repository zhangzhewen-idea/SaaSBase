...
class JwtTokenGatewayTest {
    ...
    void signs_and_parses_access_token() {
        ...
        UserPrincipal principal = new UserPrincipal(1001L, 2001L, "alice", Set.of("tenant:user:read"), 7L);
    ...
    void issues_a_token_with_a_non_blank_token_id() {
        JwtTokenGateway gateway = new JwtTokenGateway("01234567890123456789012345678901", Duration.ofMinutes(15));
        String token = gateway.issueAccessToken(new UserPrincipal(1001L, 2001L, "alice", Set.of(), 0L));
